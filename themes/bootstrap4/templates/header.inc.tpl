...
<div id="reportico-full-page-spinner" class="w-100 d-flex justify-content-center align-items-center" style="color: #0a0; position: fixed; width: 100%; z-index:9999">
    <div id="reportico-spinner-overlay" >
    </div>
</div>
</div>
