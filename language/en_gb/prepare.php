...
$locale_arr = array (
   ...
   "template" => array (
        ...
        "T_EDITDISPLAYORDER" => "Display Order",
        "T_EDITGROUPHEADERS" => "Group Headers",
        "T_EDITGROUPTRAILERS" => "Group Trailers",
        "T_EDITPRESQLS" => "Pre-SQLs",
        "T_EDITTITLE" => "Title",
        "T_EDITCUSTOMSOURCE" => "Custom Source Code",
        "T_EDITDESCRIPTION" => "Report Description",
        "T_EDITPAGESETUP" => "Page Setup",
        "T_EDITGRID" => "Dynamic Grid Setup",
        "T_EDITSQL" => "SQL",
