...
<!DOCTYPE html>
<HTML>
    {include file="bootstrap3/head.inc.tpl"}
...
<script type="text/javascript">var reportico_ajax_script = "{/literal}{$SCRIPT_SELF}{literal}";</script>
{/literal}
    				       ...
    				       <button type="submit" class="btn btn-default prepareMiniMaintain swMiniMaintain" title="{$T_EDIT} {$T_EDITSQL}" id="submit_mainquerqury_SHOW" name="mainquerqurysqlt_QuerySql">
                            ...
                            <div class="btn-group" role="group"> 
                                ...
                                <ul class="dropdown-menu">
                                    <li><button type="submit" title="{$T_EDIT} {$T_EDITPAGEHEADERS}" id="submit_mainqueroutppghd0000form" value="{$T_EDITPAGEHEADERS}" name="mainqueroutppghd0000form_ANY"></li>
                                    <li><button type="submit" title="{$T_EDIT} {$T_EDITPAGEFOOTERS}" id="submit_mainqueroutppgft0000form" value="{$T_EDITPAGEFOOTERS}" name="mainqueroutppgft0000form_ANY"></li>
                                    <li><button type="submit" title="{$T_EDIT} {$T_EDITPRESQLS}" id="submit_mainquerqurypsql_SHOW" value="{$T_EDITPRESQLS}" name="mainquerqurypsql_ANY"></li>
                                </ul>
                            <div class="btn-group" role="group">
                        </div>
                </ul>   
