...
{if !$BOOTSTRAP_STYLES}
{literal}
<script type="text/javascript" src="{/literal}{$ASSETS_PATH}/js{literal}/jquery.jdMenu.js"></script>
<LINK id="reportico_css" REL="stylesheet" TYPE="text/css" HREF="{/literal}{$ASSETS_PATH}/js{literal}/jquery.jdMenu.css">
{/literal}
{/if}
{literal}
...
<script type="text/javascript">var reportico_css_path = "{/literal}{$THEME_DIR}/css/reportico_bootstrap.css{literal}";</script>
{/literal}
{/if}
{if $REPORTICO_CHARTING_ENGINE == "FLOT" }
{literal}
<script type="text/javascript" src="{/literal}{$ASSETS_PATH}/js{literal}/flot/jquery.flot.js"></script>
<script type="text/javascript" src="{/literal}{$ASSETS_PATH}/js{literal}/flot/jquery.flot.axislabels.js"></script>
{/literal}
{/if}
...
<LINK id="nvd3_css" REL="stylesheet" TYPE="text/css" HREF="{/literal}{$ASSETS_PATH}/js{literal}/nvd3/nv.d3.css">
{/literal}
{/if}
{/if}
{if !$REPORTICO_AJAX_PRELOADED}
{literal}
<script type="text/javascript" src="{/literal}{$ASSETS_PATH}/js{literal}/jquery.dataTables.min.js"></script>
{/literal}
